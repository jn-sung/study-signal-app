...
export const LightMapModal: React.FC<LightMapModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
      <div className="relative w-full max-w-4xl h-[80vh] bg-gray-900 rounded-2xl overflow-hidden shadow-2xl border border-gray-700">
        ...
        {/* Map Visualization */}
        <div className="w-full h-full relative bg-gradient-to-b from-gray-900 via-slate-900 to-black">
